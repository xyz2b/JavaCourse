package Netty.NettyHttpServer;

import Netty.NettyHttpClient.NettyHttpClient;
...
public class HttpHandler extends ChannelInboundHandlerAdapter {
    ...
    private void handlerTest(FullHttpRequest fullHttpRequest, ChannelHandlerContext ctx) {
        ...
        try {
            ...
            HttpRequest request = NettyHttpClient.getRequestMethod(getData, url, "get");

            String value = new NettyHttpClient().run(url, request); // "hello,kimmking"; // 对接上次作业的httpclient或者okhttp请求另一个url的响应数据
