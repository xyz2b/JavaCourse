CREATE TABLE IF NOT EXISTS `customer` (
	...
	`create_date`			TIMESTAMP DEFAULT CURRENT_TIMESTAMP COMMENT	'注册时间',
...
CREATE TABLE IF NOT EXISTS `product` (
	...
	`product_info`			TEXT DEFAULT NULL COMMENT '商品介绍',
	`product_category`		VARCHAR(10) DEFAULT 'default' COMMENT '商品分类',
	`create_date`			TIMESTAMP DEFAULT CURRENT_TIMESTAMP COMMENT '上架时间',
	`update_date`			TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间',
	`is_delete`				TINYINT NOT NULL COMMENT '是否删除',
